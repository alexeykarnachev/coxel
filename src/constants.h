...
#define MAX_N_SCENE_COMPONENTS MAX_N_CAMERAS + MAX_N_MESHES + MAX_N_TRANSFORMATIONS + MAX_N_MATERIALS + MAX_N_POINT_LIGHTS + MAX_N_POINT_SHADOW_CASTERS + MAX_N_SCRIPTS
