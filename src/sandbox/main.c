...
int main(void) {
    ...
    size_t plane_0 = entity_create(-1);
    ...
    size_t sphere_0 = entity_create(-1);
    entity_add_component(
    ...
    entity_add_component(sphere_0, HAS_POINT_SHADOW_T, NULL);

    size_t sphere_1 = entity_create(-1);
    entity_add_component(
    ...
    entity_add_component(sphere_1, HAS_POINT_SHADOW_T, NULL);

    size_t sphere_2 = entity_create(-1);
    entity_add_component(
    ...
    size_t point_light_0 = entity_create(-1);
    ...
    size_t point_light_1 = entity_create(-1);
    entity_add_component(
    ...
    size_t point_light_2 = entity_create(-1);
    entity_add_component(
    ...
    size_t point_light_3 = entity_create(-1);
    entity_add_component(
    ...
    size_t camera_0 = entity_create(-1);
    entity_add_component(
