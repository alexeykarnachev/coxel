...
int main(void) {
    ...
    ecs_add_component(suzanne_0, MESH_T, mesh_create_suzanne());
    ecs_add_component(suzanne_0, MATERIAL_T, material_create_default());
    ...
    ecs_add_component(ironman_0, MATERIAL_T, material_create_default());
    ...
    ecs_add_component(plane_0, MATERIAL_T, material_create_default());
    ...
    ecs_add_component(sphere_0, MESH_T, mesh_create_sphere());
    ecs_add_component(
        sphere_0, MATERIAL_T, material_create(vec3(0.9, 0.2, 0.2), 0.0)
    );
    ...
    ecs_add_component(sphere_1, MESH_T, mesh_create_sphere());
    ecs_add_component(
        sphere_1, MATERIAL_T, material_create(vec3(0.2, 0.9, 0.2), 0.0)
    );
    ...
    ecs_add_component(sphere_2, MESH_T, mesh_create_sphere());
    ecs_add_component(
        sphere_2, MATERIAL_T, material_create(vec3(0.2, 0.2, 0.9), 0.0)
    );
    ...
    ecs_add_component(sphere_3, MESH_T, mesh_create_sphere());
    ecs_add_component(
        sphere_3, MATERIAL_T, material_create(vec3(0.1, 0.1, 0.95), 0.0)
    );
    ...
    ecs_add_component(sphere_4, MESH_T, mesh_create_sphere());
    ecs_add_component(
        sphere_4, MATERIAL_T, material_create(vec3(0.1, 0.1, 0.95), 0.0)
    );
    ...
    ecs_add_component(camera_0, CAMERA_T, camera_create_default());
